...
The Portable experimental profile requires Linux x86_64 (amd64).
On another architecture, onboarding stops before it inspects or changes Portable host state.
