...
- Managed images now include OpenClaw 2026.9.1 and Hermes 0.21.3.
  ...
  OpenClaw device approval now exits after both direct-gateway and local-fallback output drains; a drain failure or timeout exits nonzero instead of waiting on leftover gateway handles.
